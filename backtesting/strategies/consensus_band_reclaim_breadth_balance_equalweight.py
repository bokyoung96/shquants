...
from backtesting.signals.consensus_band_reclaim_breadth_balance import ConsensusBandReclaimBreadthBalanceSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthBalanceEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthBalanceSignalProducer(
