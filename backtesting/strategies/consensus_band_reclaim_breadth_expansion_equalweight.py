...
from backtesting.signals.consensus_band_reclaim_breadth_expansion import ConsensusBandReclaimBreadthExpansionSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthExpansionEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthExpansionSignalProducer(
