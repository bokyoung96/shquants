...
from backtesting.signals.consensus_band_reclaim_breadth_reaccel import ConsensusBandReclaimBreadthReaccelSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthReaccelEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthReaccelSignalProducer(
