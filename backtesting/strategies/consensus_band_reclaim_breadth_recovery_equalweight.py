...
from backtesting.signals.consensus_band_reclaim_breadth_recovery import ConsensusBandReclaimBreadthRecoverySignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthRecoveryEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthRecoverySignalProducer(
