...
from backtesting.signals.consensus_band_reclaim_breadth_regime_coarse import ConsensusBandReclaimBreadthRegimeCoarseSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthRegimeCoarseEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthRegimeCoarseSignalProducer(
