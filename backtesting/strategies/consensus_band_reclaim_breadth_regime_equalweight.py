...
from backtesting.signals.consensus_band_reclaim_breadth_regime import ConsensusBandReclaimBreadthRegimeSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimBreadthRegimeEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimBreadthRegimeSignalProducer(
