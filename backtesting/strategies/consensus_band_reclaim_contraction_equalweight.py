...
from backtesting.signals.consensus_band_reclaim_contraction import ConsensusBandReclaimContractionSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimContractionEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimContractionSignalProducer(
