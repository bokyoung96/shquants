...
from backtesting.signals.consensus_band_reclaim_contraction_reaccel import ConsensusBandReclaimContractionReaccelSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimContractionReaccelEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimContractionReaccelSignalProducer(
