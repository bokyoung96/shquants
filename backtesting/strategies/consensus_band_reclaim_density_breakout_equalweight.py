...
from backtesting.signals.consensus_band_reclaim_density_breakout import ConsensusBandReclaimDensityBreakoutSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimDensityBreakoutEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimDensityBreakoutSignalProducer(
