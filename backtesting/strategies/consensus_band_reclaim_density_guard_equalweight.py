...
from backtesting.signals.consensus_band_reclaim_density_guard import ConsensusBandReclaimDensityGuardSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimDensityGuardEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimDensityGuardSignalProducer(
            ...
            reclaim_buffer=self.reclaim_buffer,
