...
from backtesting.signals.consensus_band_reclaim_density_ramp import ConsensusBandReclaimDensityRampSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimDensityRampEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimDensityRampSignalProducer(
