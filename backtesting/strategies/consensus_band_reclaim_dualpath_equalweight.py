...
from backtesting.signals.consensus_band_reclaim_dualpath import ConsensusBandReclaimDualPathSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimDualPathEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimDualPathSignalProducer(
