...
from backtesting.signals.consensus_band_reclaim_soft_breadth import ConsensusBandReclaimSoftBreadthSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimSoftBreadthEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimSoftBreadthSignalProducer(
