...
from backtesting.signals.consensus_band_reclaim_tight_exit import ConsensusBandReclaimTightExitSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusBandReclaimTightExitEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusBandReclaimTightExitSignalProducer(
