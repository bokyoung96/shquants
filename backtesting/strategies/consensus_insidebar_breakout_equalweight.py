...
from backtesting.signals.consensus_insidebar_breakout import ConsensusInsideBarBreakoutSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class ConsensusInsideBarBreakoutEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = ConsensusInsideBarBreakoutSignalProducer(
            revision_lookback=self.revision_lookback,
            mother_lookback=self.mother_lookback,
