...
def main(argv: list[str] | None = None) -> None:
    ...
    logger = configure_logging(log_path, logger_name="emp008_full")
    ...
    try:
        ...
        logger.info("EMP008 full run completed")
        print(json.dumps(summary, ensure_ascii=False, indent=2))
    except Exception:
        logger.exception("EMP008 full run failed")
        raise


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run EMP008 weights, backtest, and report with logs.")
