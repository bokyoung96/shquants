...
from backtesting.signals.kospi200_sector_momentum_op_event import Kospi200SectorMomentumOpEventSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class Kospi200SectorMomentumOpEventEqualWeight(RegisteredStrategy):
    def __post_init__(self) -> None:
        self.signal_producer = Kospi200SectorMomentumOpEventSignalProducer()
