...
from backtesting.signals.oversold_reversal_band import OversoldReversalBandSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class OversoldReversalBand(RegisteredStrategy):
    boll_lookback: int = 20
    rebound_lookback: int = 3
    max_hold_days: int = 10

    def __post_init__(self) -> None:
        self.signal_producer = OversoldReversalBandSignalProducer(
