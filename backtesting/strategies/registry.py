...
from .rrg_sector_rotation import RrgFwdBenchmarkTilt, RrgPureSectorRotation, RrgSectorRotation
...
register_strategy("rrg_fwd_benchmark_tilt", RrgFwdBenchmarkTilt)
register_strategy("rrg_pure_sector_rotation", RrgPureSectorRotation)
