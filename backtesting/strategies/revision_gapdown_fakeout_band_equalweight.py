...
from backtesting.signals.revision_gapdown_fakeout_band import RevisionGapdownFakeoutBandSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class RevisionGapdownFakeoutBandEqualWeight(RegisteredStrategy):
