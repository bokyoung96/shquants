...
class RevisionOiShortSqueezeBetaExclusionLs(ComposableStrategy):
    lookback: int = 20
    flow_lookback: int = 20
    momentum_lookback: int = 60

    def __post_init__(self) -> None:
        self.signal_producer = _RevisionOiShortSqueezeBetaExclusionSignalProducer(
...
@dataclass(slots=True)
class _RevisionOiShortSqueezeBetaExclusionSignalProducer:
    lookback: int = 20
    flow_lookback: int = 20
    momentum_lookback: int = 60
