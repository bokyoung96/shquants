...
class RevisionOiStateConditionedBetaGateLs(ComposableStrategy):
    lookback: int = 20
    flow_lookback: int = 20
    momentum_lookback: int = 60

    def __post_init__(self) -> None:
        self.signal_producer = _RevisionOiStateConditionedBetaGateSignalProducer(
...
@dataclass(slots=True)
class _RevisionOiStateConditionedBetaGateSignalProducer:
    lookback: int = 20
    flow_lookback: int = 20
    momentum_lookback: int = 60
