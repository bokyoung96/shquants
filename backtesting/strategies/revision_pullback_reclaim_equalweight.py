...
from backtesting.signals.revision_pullback_reclaim import RevisionPullbackReclaimSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class RevisionPullbackReclaimEqualWeight(RegisteredStrategy):
