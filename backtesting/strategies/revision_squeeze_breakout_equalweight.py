...
from backtesting.signals.revision_squeeze_breakout import RevisionSqueezeBreakoutSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class RevisionSqueezeBreakoutEqualWeight(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = RevisionSqueezeBreakoutSignalProducer(
            revision_lookback=self.revision_lookback,
            squeeze_short=self.squeeze_short,
            squeeze_long=self.squeeze_long,
