...
from backtesting.signals.volatility_squeeze_breakout import VolatilitySqueezeBreakoutSignalProducer

from .base import RegisteredStrategy


@dataclass(slots=True)
class VolatilitySqueezeBreakout(RegisteredStrategy):
    ...
    def __post_init__(self) -> None:
        self.signal_producer = VolatilitySqueezeBreakoutSignalProducer(
